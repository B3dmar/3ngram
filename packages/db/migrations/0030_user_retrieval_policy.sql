CREATE TABLE "user_retrieval_policy" (
	...
	CONSTRAINT "user_retrieval_policy_scope_consistency_check" CHECK ((("user_retrieval_policy"."mode" = 'off' AND "user_retrieval_policy"."default_scope" IS NULL) OR ("user_retrieval_policy"."mode" = 'default' AND "user_retrieval_policy"."default_scope" IS NOT NULL) OR ("user_retrieval_policy"."mode" = 'require' AND "user_retrieval_policy"."default_scope" IS NULL)))
);
