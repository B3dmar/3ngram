...
- Official **TS SDK v2 packages pinned `2.0.0`** + **Express**. One stateless dual-era handler serves legacy and `2026-07-28` clients. Keep Express: changing the protocol generation and HTTP framework together would add migration risk without a product benefit.
