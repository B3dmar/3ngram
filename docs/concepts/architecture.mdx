...
│   ├── worker/            # BullMQ consumers: consolidation, surfacing, gc-clients
...
- **50-line function / 500-line file budget.** Target, not a lint rule — same as [AGENTS.md](https://github.com/B3dmar/3ngram/blob/staging/AGENTS.md) hard rule 5. Oversized files in core paths are the failure mode the budget is there to prevent.
